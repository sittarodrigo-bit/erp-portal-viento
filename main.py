...
# ==============================================================================
# CONFIGURACIONES GLOBALES (DB y MP)
# ==============================================================================
    ...
    try:
        ...
        for lid in locales:
            ...
            if cur.fetchone():
                salteados += 1
                continue
            cur.execute("INSERT INTO pos_productos (id_local, nombre, precio, categoria, stock, stock_alerta) VALUES (%s,%s,%s,%
